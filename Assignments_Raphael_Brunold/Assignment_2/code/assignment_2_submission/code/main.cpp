	...
	*/
	void sceneDefinition (){
		...
		*/
		...
		green_diffuse.ambient = glm::vec3(0.0f, 0.7f, 0.1f);
		green_diffuse.diffuse = glm::vec3(0.0f, 0.7f, 0.1f);

		Material red_specular;
		red_specular.ambient = glm::vec3(0.9f, 0.05f, 0.05f);
		red_specular.diffuse = glm::vec3(0.9f, 0.05f, 0.05f);
		red_specular.specular = glm::vec3(0.5);
		red_specular.shininess = 10.0;

		Material blue_specular;
		blue_specular.ambient = glm::vec3(0.1f, 0.1f, 1.0f);
		blue_specular.diffuse = glm::vec3(0.1f, 0.1f, 1.0f);
